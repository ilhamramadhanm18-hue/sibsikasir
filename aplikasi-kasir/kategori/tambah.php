...
if (isset($_POST['simpan'])) {
    ...
    if ($nama_kategori != '') {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            // SINKRONISASI: Diubah menjadi 'tambah_sukses' agar klop dengan index kategori Anda
...
<body>
            ...
            <div class="col-md-6 col-lg-5">
                <div class="card p-4">
                    <div class="d-flex align-items-center gap-3 mb-2">
                        <div class="p-3 bg-primary-subtle text-primary rounded-4 d-inline-flex">
                            <i class="fa-solid fa-folder-plus fa-xl"></i>
                        </div>
                        <div>
                            <h3 class="fw-800 m-0 text-dark" style="letter-spacing: -0.5px;">Tambah Kategori</h3>
                            <p class="text-muted m-0 small">Buat kelompok baru untuk mengorganisir barang.</p>
                        </div>
                    </div>
                    ...
                    <form action="" method="POST" autocomplete="off">
                        <div class="mb-4">
                            <div class="form-label-wrapper">
                                <i class="fa-solid fa-folder-tree text-muted small"></i>
    ...
    <script>
        ...
        // 1. Pop-up Error Otomatis jika validasi PHP mendeteksi kegagalan
        <?php if(!empty($error_message)): ?>
        Swal.fire({
            icon: 'error',
        ...
        document.querySelector('.btn-batal').addEventListener('click', function(e) {
            ...
            Swal.fire({
                ...
                text: "Nama kategori yang sudah Anda ketik akan hilang.",
                icon: 'warning',
